...
export const DOC_SECTIONS: DocSection[] = [
...

  {
    ...
    words: 520,
    summary:
      "A foundational introduction to Levershare’s central question: how closely measurable human contribution and economic outcomes can be aligned.",
    Content: () => (
      <>
        <section className="space-y-8">
          <div className="relative overflow-hidden rounded-3xl border border-cyan-400/20 bg-gradient-to-br from-cyan-500/10 via-purple-500/10 to-black p-6 md:p-8">
            ...
            <div className="relative">
              ...
              <div className="mt-8 space-y-5 text-sm leading-relaxed text-white/68 md:text-base md:leading-relaxed">
                <p>
                  Humanity has spent thousands of years improving the way value
                  moves through society.
                </p>

                <p>
                  Markets expanded. Money evolved. Institutions emerged.
                  Technology accelerated exchange. Each generation inherited
                  these systems and found new ways to improve them.
                </p>

                <p>
                  Yet every generation also inherits the assumptions beneath
                  those systems. Some continue to serve us remarkably well.
                  Others deserve to be questioned.
                </p>

                <p>
                  For years, one question stayed with me. Not because I believed
                  I already knew the answer, but because I was no longer convinced
                  we were asking the right question in the first place.
                </p>
                ...
                <p>
                  Far less attention has been given to an earlier question.
                </p>
              </div>
              ...
              <div className="mt-8 space-y-5 text-sm leading-relaxed text-white/68 md:text-base md:leading-relaxed">
                <p>
                  That distinction matters. Because every economy ultimately
                  grows what it is able to recognize.
                </p>

                <p>
                  What can be recognized can be coordinated. What can be
                  coordinated can be rewarded. What can be rewarded attracts
                  participation. And what attracts participation gradually shapes
                  the future of an economy.
                </p>

                <p>
                  Throughout history, the ability to recognize human contribution
                  has always been limited by the tools available at the time.
                </p>

                <p>Today, those tools are changing.</p>

                <p>
                  Blockchain, artificial intelligence, cryptography, and global
                  digital networks make it possible to recognize, verify,
                  coordinate, and record certain forms of measurable contribution
                  in ways that were previously impractical or impossible.
                </p>

                <p>
                  Whether these technologies can also improve the relationship
                  between measurable contribution and economic outcomes remains
                  an open question.
                </p>
              </div>
              ...
              <div className="mt-8 space-y-5 text-sm leading-relaxed text-white/68 md:text-base md:leading-relaxed">
                <p>
                  It is not built on the assumption that every contribution can
                  be measured. Nor does it assume that every measurable
                  contribution can or should be rewarded perfectly.
                </p>

                <p>Its starting point is far simpler.</p>

                <p>
                  If modern technologies can progressively improve how measurable
                  human contribution is recognized, then perhaps they can also
                  progressively improve how economic outcomes align with that
                  contribution.
                </p>

                <p>
                  Whether that hypothesis proves correct is something no
                  whitepaper can determine.
                </p>

                <p>
                  Only an open system, real participants, continuous learning,
                  and time can do that.
                </p>

                <p>Levershare is our attempt to build that system.</p>

                <p>
                  Not because we claim to have found the final answer. But
                  because we believe this question deserves to be explored.
                </p>
              </div>
