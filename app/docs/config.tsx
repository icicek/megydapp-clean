...
export const DOC_SECTIONS: DocSection[] = [
...

  {
    ...
    words: 560,
    summary:
      "A foundational introduction to the central question behind Levershare: whether modern technologies can progressively improve the relationship between meaningful human contribution and economic outcomes.",
    Content: () => (
      <>
        <section className="space-y-8">
          <article className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              ...
              <p>
                For years, one question stayed with me. Not because I believed I
                already knew the answer, but because I was no longer convinced we
                were asking the right question in the first place.
              </p>
  
              <p>
                Much of our attention has been devoted to how wealth should be
                created, distributed, taxed, or transferred.
              </p>
            ...
            <div className="my-10">
              <BookQuote>
                How closely can measurable human contribution and economic
                outcomes be aligned?
              </BookQuote>
            </div>
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>
                That distinction matters because every economy ultimately grows
                what it is able to recognize.
              </p>
  
              <p>
                What can be recognized can be coordinated. What can be coordinated
                can be rewarded. What can be rewarded attracts participation. And
                what attracts participation gradually shapes the future of an
                economy.
              </p>
  
              <p>
                Throughout history, the ability of economic systems to recognize
                meaningful human contribution has always been constrained by the
              ...
              <p>
                Modern technologies are expanding the ways in which certain forms
                of meaningful human contribution can be recognized, coordinated,
                verified, and recorded.
              </p>
  
              <p>
                Blockchain, artificial intelligence, cryptography, and global
                digital networks are among the technologies making that exploration
                possible.
              </p>
  
              <p>
                Whether these technologies can also improve the relationship
                between meaningful human contribution and economic outcomes remains
                an open question.
              </p>
            </div>
            ...
            <div className="my-10">
              <BookQuote>
                Levershare explores whether modern technologies can progressively
                improve the alignment between meaningfully measurable contribution
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>
                It is not built on the assumption that every contribution can be
                measured.
              </p>
  
              <p>
                Nor does it assume that every measurable contribution can or
                should be rewarded perfectly.
              </p>
              ...
              <p>
                If modern technologies can progressively improve how meaningful
                human contribution is recognized, perhaps they can also
                progressively improve how economic outcomes align with that
                contribution.
              </p>
  
              <p>
                Whether that hypothesis proves correct is something no whitepaper
                can determine.
              </p>
  
              <p>
                Only an open system, real participants, continuous learning, and
                time can do that.
              </p>
              ...
              <p>
                If our assumptions prove incomplete, we will improve them. If our
                models prove insufficient, we will refine them.
              </p>
              ...
              <p>
                It is to learn whether better alignment can help humanity benefit
                more fully from its own potential.
              </p>
            </div>
...

  {
    ...
    words: 710,
    summary:
      "Explores why income inequality may begin long before income is distributed: where meaningful human contribution is recognized.",
    Content: () => (
      <>
        <section className="space-y-8">
          <article className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              ...
              <p>
                ...
                organizations publish reports about it. Entire political movements
                are built around it.
              </p>
  
              <p>
                Yet despite decades of research, economic growth, institutional
                reform, technological progress, and countless policy proposals, it
                remains one of the defining characteristics of the modern world.
              </p>
              ...
              <p>
                But perhaps they also invite a different question.
              </p>
            </div>
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>
                Most discussions begin after income already exists.
              </p>
              ...
              <p>
                But they all examine the final stage of a much longer economic
                process.
              </p>
  
              <p>
                Levershare begins by asking an earlier question.
              </p>
              ...
              <p>
                Some contributions are highly visible.
              </p>
              ...
              <p>
                Economic outcomes are not always aligned in the same way.
              </p>
            </div>
  
            <div className="my-10">
              <BookQuote>
                Income inequality may not begin where income is distributed.
                It may begin where contribution is recognized.
              </BookQuote>
            </div>
  
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>
                This observation is not an argument against markets.
              </p>
  
              <p>
                Nor against entrepreneurship.
              </p>
              ...
              <p>
                Markets remain one of humanity's greatest achievements.
              </p>
  
              <p>
                But perhaps they are still evolving.
              </p>
  
              <p>
                Perhaps one question deserves more attention than it has received.
              </p>
            </div>
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>
                Levershare does not claim to know the perfect answer.
              </p>
              ...
              <p>
                Some should never become economic transactions.
              </p>
  
              <p>
                Levershare asks a narrower question.
              </p>
  
              <p>
                It focuses on meaningfully measurable contribution.
              </p>
              ...
              <p>
                But perhaps to reduce economic misalignment.
              </p>
  
              <p>
                Better recognition does more than improve measurement.
              </p>
              ...
              <p>
                When people believe that meaningful contributions are more likely
                to produce meaningful economic outcomes, something important
                begins to change.
              </p>
  
              <p>
                They become more willing to invest in themselves, develop new
                capabilities, experiment with new ideas, and participate more
                actively in creating economic value.
              </p>
  
              <p>
                In that sense, improving the relationship between contribution and
                economic outcomes may influence more than fairness.
              </p>
  
              <p>
                It may influence participation itself.
              </p>
            ...
            <div className="my-10">
              <BookQuote>
                ...
                hidden capital.
                Perhaps it is meaningful human contribution that never becomes
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              ...
              <p>
                It may also be about enabling more people to participate with
                confidence, create meaningful value, and contribute to human
                progress.
              </p>
  
              <p>
                That is the possibility Levershare exists to explore.
              </p>
              ...
              <p>
                But because humanity may now possess tools capable of asking
                better questions than ever before.
              </p>
            </div>
          </article>
        </section>
...

  {
    ...
    words: 760,
    summary:
      "Explores how economic systems evolve by expanding their ability to recognize, coordinate, and benefit from meaningful human contribution.",
    Content: () => (
      <>
        <section className="space-y-8">
          <article className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>
                Human potential has always exceeded the ability of economic systems
                to recognize it.
              </p>

              <p>
                As a result, economies have never been able to fully benefit from it.
              </p>

              <p>
                This has rarely reflected a lack of human creativity or willingness
                to contribute. More often, it has reflected the limits of the
                institutions, technologies, and coordination mechanisms available at
                the time.
              </p>

              <p>
                Throughout history, people have continuously discovered new ways to
                create value. Economic systems, however, have only been able to
                coordinate the forms of contribution they could meaningfully observe,
                verify, exchange, and reward.
              </p>

              <p>Human beings create value.</p>

              <p>
                Economic systems determine how much of that value can meaningfully
                participate in economic life.
              </p>

              <p>
                That distinction has quietly shaped the history of civilization.
              </p>
            </div>
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>History offers countless examples.</p>

              <p>
                Double-entry bookkeeping did not create commerce. It made
                increasingly complex commerce possible.
              </p>

              <p>
                Patent systems did not create invention. They made invention
                economically sustainable.
              </p>

              <p>
                The internet did not create knowledge. It dramatically reduced the
                cost of sharing, organizing, and building upon knowledge.
              </p>

              <p>
                Open-source software did not invent collaboration. It made global
                collaboration possible at a scale that had never existed before.
              </p>
              ...
              <p>Different centuries.</p>

              <p>Yet the same underlying principle appears again and again.</p>

              <p>Technology does not create human potential.</p>

              <p>
                It expands what economic systems are capable of doing with it.
              </p>

              <p>History reveals a remarkably consistent pattern.</p>
              ...
              <p>As participation expands, experimentation expands.</p>

              <p>As experimentation expands, innovation accelerates.</p>

              <p>As innovation accelerates, prosperity expands.</p>

              <p>
                Economic progress has therefore never depended solely on producing
                more.
              </p>

              <p>
                It has also depended on enabling more people to become producers.
              </p>
              ...
              <p>
                Perhaps the future of economic progress depends less on discovering
                new human potential...
              </p>

              <p>...and more on enabling more of it to participate.</p>

              <p>Economic systems have never been static.</p>

              <p>
                Every generation has inherited institutions shaped by the
                technologies available in its own time.
              </p>

              <p>
                Some generations have also expanded what those institutions made
                possible.
              </p>

              <p>
                History rarely changes because existing systems suddenly disappear.
              </p>

              <p>
                It changes because better ways of coordinating human activity
                gradually become possible.
              </p>

              <p>
                Every economic system has reflected the possibilities of its own era.
              </p>

              <p>
                As those possibilities expanded, economic systems evolved.
              </p>

              <p>Not by rejecting the past.</p>

              <p>But by building upon it.</p>

              <p>Levershare begins with that observation.</p>

              <p>
                Not with the assumption that existing economic systems have failed.
              </p>

              <p>Nor with the belief that previous generations were wrong.</p>
              ...
              <p>
                ...
                and reward meaningful human contribution more effectively than ever
                before?
              </p>
              ...
              <p>...but to participate meaningfully in creating it?</p>

              <p>
                If the hypothesis proves correct, more people may gain meaningful
                opportunities to influence their own economic outcomes through their
                own contributions.
              </p>

              <p>Levershare does not promise equal outcomes.</p>

              <p>It seeks to expand equal opportunities to create them.</p>

              <p>It is not designed to create more transactions.</p>

              <p>It is designed to create more creators.</p>

              <p>People will not join Levershare to build a PVC.</p>

              <p>
                They will build a PVC because they choose to build a life centered on
            ...
            <div className="space-y-6 text-sm leading-relaxed text-white/70 md:text-base md:leading-8">
              <p>Every economy grows what it chooses to recognize.</p>

              <p>
                Perhaps the next chapter of economic progress begins by choosing
                more wisely.
              </p>
            </div>
          </article>
      ...
      <>
        <section className="space-y-8">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-purple-300/20 bg-purple-300/5 p-5">
              ...
              <p className="mt-3 text-sm leading-relaxed text-white/65">
                ...
                economic activation, global expansion, fund formation, PVC utility, open
                Proof of Value adoption, and global value economy development.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-5">
              {[
                ...
                },
                {
                  ...
                  subtitle: "Coincarnation expands beyond Solana.",
                  desc:
                ...
                },
                {
                  ...
                  subtitle: "Capital becomes professionally governed opportunity.",
                  desc:
                ...
                },
                {
                  ...
                  statusType: "future",
                  title: "Utility Epoch",
                  subtitle: "PVC becomes usable beyond recognition history.",
                  desc:
                ...
                },
                {
                  ...
                  status: "○ Future",
                  statusType: "vision",
                  title: "Global Value Economy Epoch",
                  subtitle: "The long-term vision matures into a global value economy.",
                  desc:
                ...
                >
                    ...
                    className={[
                      ...
                      epoch.statusType === "active"
                        ...
                        : epoch.statusType === "next"
                          ...
                          : epoch.statusType === "vision"
                            ? "border-amber-300/20 bg-gradient-to-br from-amber-500/10 via-black/25 to-purple-500/10"
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      {(epoch.statusType === "active" || epoch.statusType === "next") ? (
                        <div className="mt-5 space-y-4">
                          ...
                          <div
                            className={[
                              "rounded-2xl border-l-4 bg-white/[0.04] p-4",
                              epoch.statusType === "next"
                                ? "border-purple-300"
                                : "border-cyan-300",
                            ].join(" ")}
                        ...
                        <div className="mt-5 space-y-4">
                          ...
                          <div
                            className={[
                              "rounded-2xl border-l-4 bg-white/[0.03] p-4",
                              epoch.statusType === "vision"
                                ? "border-amber-300/60"
                                : "border-white/15",
                            ].join(" ")}
          ...
          <div className="rounded-3xl border border-purple-400/20 bg-gradient-to-br from-purple-500/10 to-cyan-500/10 p-6">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/65">
              Roadmap progression is determined by validation, not time. New
              opportunities, governance decisions, technological advances, participation
              data, and regulatory developments may shape future development without
              changing the long-term direction of Coincarnation.
            </p>
          </div>
