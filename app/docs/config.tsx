...
export type DocSection = {
  ...
  title: string;
  summary?: string;
  Content: () => React.ReactElement; // JSX dönen saf fonksiyon
};
...
export const DOC_SECTIONS: DocSection[] = [
  ...
  },
  {
    ...
    Content: () => (
      <>
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>Monotone floor: <code>r_floorₖ ≥ max(r_realized₍ₖ₋₁₎, r_targetₖ)</code></li>
          <li>Effective pool: <code>P_effective = min(Pₖ, USDₖ / r_floorₖ)</code></li>
  ...
  },
  {
    ...
    summary: "Dual trigger, $0.5 SOL fee, partial claims, claim records.",
    Content: () => (
      <>
        <ul className="list-disc pl-5 space-y-1">
          <li>Dual trigger: pool threshold + minimum time window (or governance override).</li>
  ...
  },
  {
    ...
    summary: "Origin/CSRF guards, JWT admin, idempotency, rate limits, disclaimers.",
    Content: () => (
      <>
        <ul className="list-disc pl-5 space-y-1">
  ...
  },
  {
    slug: "roadmap",
    title: "Roadmap",
    summary: "Phase-1 Solana, Phase-2 EVM, Phase-3 governance & audits.",
    Content: () => (
      <>
        <ol className="list-decimal pl-5 space-y-1">
  ...
  },
  {
    slug: "disclaimers",
    title: "Disclaimers",
    summary: "Informational document; parameters may evolve through governance.",
    Content: () => (
      <>
        <p>
