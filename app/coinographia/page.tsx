                    ...
                    <div className="relative p-6 md:p-7 xl:p-8">
                        <div className="flex flex-col gap-7 xl:grid xl:grid-cols-[minmax(0,1.25fr)_minmax(520px,560px)] xl:gap-7 xl:items-stretch">
                            ...
                            <div className="min-w-0 xl:h-full xl:flex xl:flex-col">
                                ...
                                <div className="relative grid min-w-0 gap-3 xl:flex-1 rounded-[26px] border border-cyan-400/12 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.10),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(168,85,247,0.10),transparent_28%),rgba(255,255,255,0.025)] p-4 shadow-[0_0_42px_rgba(34,211,238,0.07)]">
