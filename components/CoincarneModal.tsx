    ...
    <>
      ...
      >
        ...
        <DialogContent
          ...
          className="z-50 w-[92vw] max-w-md max-h-[calc(100dvh-2rem)] overflow-y-auto overscroll-contain rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.08),transparent_26%),radial-gradient(circle_at_bottom_right,rgba(168,85,247,0.08),transparent_24%),linear-gradient(135deg,#050505,#101014_58%,#09090b)] p-6 text-white shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_30px_80px_rgba(0,0,0,0.65),0_0_60px_rgba(34,211,238,0.06)] backdrop-blur-xl flex flex-col justify-start"
        >
          <button
            type="button"
            onClick={() => {
          ...
          {resultData ? (
            ...
            <>
              ...
              {balanceNotice && (
                <div className="mb-3 rounded-2xl border border-amber-400/25 bg-amber-500/[0.08] px-4 py-3 text-center text-xs text-amber-200">
                  {balanceNotice}
                </div>
              )}
              ...
              {isBackpackMobile() && (
                <div className="mb-4 rounded-xl border border-amber-400/50 bg-amber-500/15 px-4 py-3 text-left text-xs text-amber-100 shadow-[0_0_20px_rgba(245,158,11,0.18)]">
                  <div className="mb-1 font-semibold text-amber-200">
                    ⚠️ Backpack mobile compatibility notice
                  </div>
