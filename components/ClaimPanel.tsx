    ...
    <div className="bg-zinc-950 min-h-screen py-10 px-4 sm:px-6 md:px-12 lg:px-20 text-white">
      ...
      >
        ...
        <motion.section
          ...
          className="bg-zinc-900 border border-zinc-700 rounded-xl px-3 py-4 sm:px-4 sm:py-5 mb-2"
        >
        ...
        <motion.section
          ...
          className="bg-zinc-900 border border-zinc-700 rounded-xl px-1 sm:px-2 py-4 sm:py-5 mb-2"
        >
          <h3 className="text-blue-400 text-sm font-semibold uppercase mb-4 tracking-wide">
            📊 Claim & Statistics
          </h3>
