      ...
      <div className="max-w-6xl w-full mx-auto space-y-6">
        ...
        >
          ...
          <div className="relative grid grid-cols-1 items-stretch gap-4 md:grid-cols-3">
            <div
              className="group relative h-full cursor-pointer rounded-2xl border border-white/10 bg-black/25 p-4 transition hover:border-cyan-300/30 hover:bg-cyan-400/10"
              onClick={() => {
            ...
            <div
              className="group relative h-full cursor-pointer overflow-hidden rounded-2xl border border-fuchsia-400/20 bg-fuchsia-400/10 p-4 transition hover:border-fuchsia-300/40 hover:bg-fuchsia-400/15"
              onClick={() => {
            ...
            <div className="h-full rounded-2xl border border-yellow-400/20 bg-yellow-400/10 p-4 md:col-span-1">
            ...
            <div className="h-full rounded-2xl border border-red-400/20 bg-red-400/10 p-4 md:col-span-1">
            ...
            <div className="h-full rounded-2xl border border-cyan-400/20 bg-cyan-400/10 p-4 md:col-span-1">
