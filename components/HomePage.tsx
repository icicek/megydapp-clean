        ...
        >
          ...
          <div className="space-y-3 sm:hidden">
            {[
              ...
              <div
                key={item.step}
                className="flex items-start gap-4 rounded-2xl border border-white/10 bg-[linear-gradient(135deg,rgba(34,211,238,0.045),rgba(255,255,255,0.02),rgba(139,92,246,0.045))] px-4 py-4 shadow-[0_12px_28px_rgba(0,0,0,0.18)]"
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-cyan-300/20 bg-cyan-400/[0.07] text-[10px] font-black tracking-[0.16em] text-cyan-100">
                  {item.step}
                </div>
          ...
          {/* Desktop */}
          <div className="relative hidden overflow-hidden rounded-2xl border border-cyan-300/12 bg-[linear-gradient(135deg,rgba(34,211,238,0.035),rgba(255,255,255,0.018),rgba(139,92,246,0.035))] px-5 py-3 shadow-[0_14px_36px_rgba(0,0,0,0.18)] sm:block">
              ...
              {[
                ...
                <React.Fragment key={item.step}>
                  <div className="flex min-w-0 flex-1 items-center gap-3">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-cyan-300/18 bg-cyan-400/[0.06] text-[10px] font-black tracking-[0.14em] text-cyan-100 shadow-[0_0_16px_rgba(34,211,238,0.08)]">
                      {item.step}
                    </div>
                  ...
                  {index < items.length - 1 && (
                    ...
                    >
                      <div className="h-px w-5 bg-gradient-to-r from-cyan-300/10 to-cyan-300/30" />
                      <span className="text-sm text-cyan-200/35">→</span>
                      <div className="h-px w-5 bg-gradient-to-r from-cyan-300/30 to-violet-300/10" />
                    </div>
                  )}
                </React.Fragment>
              ))}
            ...
            <p className="relative mt-2 text-center text-[10px] leading-5 text-white/35">
